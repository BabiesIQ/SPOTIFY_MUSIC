...
import (
	...
	"github.com/BabiesIQ/SPOTIFY_MUSIC/player/ntgcalls"
	"fmt"
	"regexp"
	"strings"
)
...
// loadMediaDescription creates a media description for ntgcalls based on the provided file path, video status, and ffmpeg parameters.
func loadMediaDescription(filePath string, isVideo bool, chatId int64, ffmpegParameters string) ntgcalls.MediaDescription {
	var duration int
	...
	originalWidth, originalHeight := loadVideoDimensions(filePath)
