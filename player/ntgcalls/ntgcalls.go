...
//#include "ntgcalls.h"
//#include <stdlib.h>
//extern void processStreamEnd(uintptr_t ptr, int64_t chatID, ntg_stream_type_enum streamType, ntg_stream_device_enum streamDevice, void*);
//extern void processUpgrade(uintptr_t ptr, int64_t chatID, ntg_media_state_struct state, void*);
//extern void processConnectionChange(uintptr_t ptr, int64_t chatID, ntg_network_info_struct networkInfo, void*);
//extern void handleSignal(uintptr_t ptr, int64_t chatID, uint8_t*, int, void*);
//extern void processFrames(uintptr_t ptr, int64_t chatID, ntg_stream_mode_enum streamMode, ntg_stream_device_enum streamDevice, ntg_frame_struct* frames, uint64_t size, void*);
//extern void processRemoteSourceChange(uintptr_t ptr, int64_t chatID, ntg_remote_source_struct remoteSource, void*);
//extern void processRequestBroadcastTimestamp(uintptr_t ptr, int64_t chatID, void*);
//extern void processRequestBroadcastPart(uintptr_t ptr, int64_t chatID, ntg_segment_part_request_struct segmentPartRequest, void*);
//extern void processLogs(ntg_log_message_struct logMessage);
import "C"
import (
	"fmt"
	"unsafe"
...
func init() {
	C.ntg_register_logger((C.ntg_log_message_callback)(unsafe.Pointer(C.processLogs)))
}

var (
	loggerNTGCalls = CreateLogger("ntgcalls", LevelInfo)
	loggerWebRTC   = CreateLogger("webrtc", LevelFatal)
)
...
func NTgCalls() *Client {
	...
	C.ntg_on_stream_end(C.uintptr_t(instance.ptr), (C.ntg_stream_callback)(unsafe.Pointer(C.processStreamEnd)), selfPointer)
	C.ntg_on_upgrade(C.uintptr_t(instance.ptr), (C.ntg_upgrade_callback)(unsafe.Pointer(C.processUpgrade)), selfPointer)
	C.ntg_on_connection_change(C.uintptr_t(instance.ptr), (C.ntg_connection_callback)(unsafe.Pointer(C.processConnectionChange)), selfPointer)
	C.ntg_on_frames(C.uintptr_t(instance.ptr), (C.ntg_frame_callback)(unsafe.Pointer(C.processFrames)), selfPointer)
	C.ntg_on_remote_source_change(C.uintptr_t(instance.ptr), (C.ntg_remote_source_callback)(unsafe.Pointer(C.processRemoteSourceChange)), selfPointer)
	C.ntg_on_request_broadcast_timestamp(C.uintptr_t(instance.ptr), (C.ntg_broadcast_timestamp_callback)(unsafe.Pointer(C.processRequestBroadcastTimestamp)), selfPointer)
	C.ntg_on_request_broadcast_part(C.uintptr_t(instance.ptr), (C.ntg_broadcast_part_callback)(unsafe.Pointer(C.processRequestBroadcastPart)), selfPointer)
	return instance
}

//export processLogs
func processLogs(logMessage C.ntg_log_message_struct) {
	message := fmt.Sprintf(
		"(%v:%v) %v",
...
//export processStreamEnd
func processStreamEnd(_ C.uintptr_t, chatID C.int64_t, streamType C.ntg_stream_type_enum, streamDevice C.ntg_stream_device_enum, ptr unsafe.Pointer) {
	self := (*Client)(ptr)
...
//export processUpgrade
func processUpgrade(_ C.uintptr_t, chatID C.int64_t, state C.ntg_media_state_struct, ptr unsafe.Pointer) {
	self := (*Client)(ptr)
	goChatID := int64(chatID)
	goState := MediaState{
...
//export processConnectionChange
func processConnectionChange(_ C.uintptr_t, chatID C.int64_t, networkInfo C.ntg_network_info_struct, ptr unsafe.Pointer) {
	self := (*Client)(ptr)
	goChatID := int64(chatID)
...
//export processFrames
func processFrames(_ C.uintptr_t, chatID C.int64_t, streamMode C.ntg_stream_mode_enum, streamDevice C.ntg_stream_device_enum, frames *C.ntg_frame_struct, size C.uint64_t, ptr unsafe.Pointer) {
	self := (*Client)(ptr)
	goChatID := int64(chatID)
...
//export processRemoteSourceChange
func processRemoteSourceChange(_ C.uintptr_t, chatID C.int64_t, remoteSource C.ntg_remote_source_struct, ptr unsafe.Pointer) {
	self := (*Client)(ptr)
	goChatID := int64(chatID)
...
//export processRequestBroadcastTimestamp
func processRequestBroadcastTimestamp(_ C.uintptr_t, chatID C.int64_t, ptr unsafe.Pointer) {
	self := (*Client)(ptr)
	goChatID := int64(chatID)
...
//export processRequestBroadcastPart
func processRequestBroadcastPart(_ C.uintptr_t, chatID C.int64_t, segmentPartRequest C.ntg_segment_part_request_struct, ptr unsafe.Pointer) {
	self := (*Client)(ptr)
	goChatID := int64(chatID)
...
//goland:noinspection GoUnusedExportedFunction
func LoadMediaDevices() MediaDevices {
