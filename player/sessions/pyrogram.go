...
// ParsePyrogramSession decodes a Pyrogram-generated session string into a gogram-compatible session object.
// It returns an error if the decoding fails or the data is malformed.
func ParsePyrogramSession(encodedString string) (*telegram.Session, error) {
	const (
		dcIDSize     = 1
		apiIDSize    = 4
		testModeSize = 1
