...
// ParseTelethonSession decodes a Telethon-generated session string into a gogram-compatible session object.
// It returns an error if the decoding fails or the data is malformed.
func ParseTelethonSession(sessionString string) (*telegram.Session, error) {
