...
var SourceCodeBtn = url("Source Code", "https://github.com/BabiesIQ/SPOTIFY_MUSIC", gotdbot.ButtonStylePrimary{})
...
func SettingsKeyboard(playMode, adminModeState string, cmdDelete bool, language string) *gotdbot.ReplyMarkupInlineKeyboard {
	playText := "Everyone"
	...
	adminText := "Everyone"
	if adminModeState == utils.Admins {
		adminText = "Admins"
	}
...
func BuildHelpMenuKeyboard() *gotdbot.ReplyMarkupInlineKeyboard {
	return &gotdbot.ReplyMarkupInlineKeyboard{
		Rows: [][]gotdbot.InlineKeyboardButton{
...
func HelpMenuBackKeyboard() *gotdbot.ReplyMarkupInlineKeyboard {
	return &gotdbot.ReplyMarkupInlineKeyboard{
		Rows: [][]gotdbot.InlineKeyboardButton{
			{HelpBtn, HomeBtn},
...
func PlayerControlButtons(mode string) *gotdbot.ReplyMarkupInlineKeyboard {
...
func JoinButtonMarkup(username string) *gotdbot.ReplyMarkupInlineKeyboard {
