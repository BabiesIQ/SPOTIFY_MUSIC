...
func playCallbackHandler(c *td.Client, cb *td.UpdateNewCallbackQuery) error {
	...
	if !cache.ChatCache.IsActive(chatID) {
		...
		_, _ = cb.EditMessageText(c, text, &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons(""), ParseMode: "HTML", DisableWebPagePreview: true})
		return nil
	}
	...
	if currentTrack == nil {
		...
		_, _ = cb.EditMessageText(c, "There is no active playback.", &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons(""), ParseMode: "HTML", DisableWebPagePreview: true})
		return nil
	}
	...
	case strings.Contains(data, "play_skip"):
		if err := vc.Calls.PlayNext(c, chatID); err != nil {
			...
			_, _ = cb.EditMessageText(c, "Unable to skip the current track.", &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons(""), ParseMode: "HTML", DisableWebPagePreview: true})
			return nil
		}
	...
	case strings.Contains(data, "play_stop"):
		if err := vc.Calls.Stop(chatID, false); err != nil {
			...
			_, _ = cb.EditMessageText(c, "Unable to stop playback.", &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons(""), ParseMode: "HTML", DisableWebPagePreview: true})
			return nil
		}
		...
		_, err := cb.EditMessageText(c, msg, &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons(""), ParseMode: "HTML", DisableWebPagePreview: true})
		return err
	...
	case strings.Contains(data, "play_pause"):
		if _, err = vc.Calls.Pause(chatID); err != nil {
			...
			_, _ = cb.EditMessageText(c, "Unable to pause playback.", &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons(""), ParseMode: "HTML", DisableWebPagePreview: true})
			return nil
		}
		...
		_, _ = cb.EditMessageText(c, text, &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons("pause"), ParseMode: "HTML", DisableWebPagePreview: true})
		return nil
	...
	case strings.Contains(data, "play_resume"):
		if _, err := vc.Calls.Resume(chatID); err != nil {
			...
			_, _ = cb.EditMessageText(c, "Unable to resume playback.", &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons("pause"), ParseMode: "HTML", DisableWebPagePreview: true})
			return nil
		}
		...
		_, _ = cb.EditMessageText(c, text, &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons("resume"), ParseMode: "HTML", DisableWebPagePreview: true})
		return nil

	case strings.Contains(data, "play_mute"):
		if _, err := vc.Calls.Mute(chatID); err != nil {
			_ = cb.Answer(c, 0, false, "Unable to mute playback.", "")
			_, _ = cb.EditMessageText(c, "Unable to mute playback.", &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons("mute"), ParseMode: "HTML", DisableWebPagePreview: true})
			return nil
		}
		_ = cb.Answer(c, 0, false, "Playback muted.", "")
		text := buildTrackMessage("Muted", "🔇") + fmt.Sprintf("\n\nMuted by %s", html.EscapeString(user.FirstName))
		_, _ = cb.EditMessageText(c, text, &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons("mute"), ParseMode: "HTML", DisableWebPagePreview: true})
		return nil
	...
	case strings.Contains(data, "play_unmute"):
		if _, err := vc.Calls.Unmute(chatID); err != nil {
			...
			_, _ = cb.EditMessageText(c, "Unable to unmute playback.", &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons("unmute"), ParseMode: "HTML"})
			return nil
		}
		_ = cb.Answer(c, 0, false, "Playback unmuted.", "")
		text := buildTrackMessage("Now Playing", "▶") + fmt.Sprintf("\n\nUnmuted by %s", html.EscapeString(user.FirstName))
		_, _ = cb.EditMessageText(c, text, &td.EditTextMessageOpts{ReplyMarkup: core.PlayerControlButtons("unmute"), DisableWebPagePreview: true})
		return nil
...
func playVcHandler(c *td.Client, cb *td.UpdateNewCallbackQuery) error {
	data := cb.DataString()
