...
// createUniquePlaylistID generates a unique ID for a playlist.
func createUniquePlaylistID() string {
	b := make([]byte, 5)
	_, _ = rand.Read(b)
...
func TransformSongsToTracks(songs []Song) []utils.MusicTrack {
