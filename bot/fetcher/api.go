...
// createApiData creates and initializes a new apiData instance with the provided query.
func createApiData(query string) *apiData {
	return &apiData{
...
func (a *apiData) downloadTrack(info utils.TrackInfo, video bool) (string, error) {
	...
	if strings.Contains(a.ApiUrl, filePath) {
		return pullFile(filePath, "", false)
	}
